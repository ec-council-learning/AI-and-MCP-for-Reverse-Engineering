...
if __name__ == "__main__":
    # Run the MCP server over HTTP so mcp-remote can connect.
    # Matches the sample mcp_automate_server: port 9888, path /mcp/
    # Listen on 0.0.0.0 so it's reachable from localhost or LAN if needed.
    mcp.run(
